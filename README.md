...
This project is based on [this](https://github.com/android/architecture-components-samples/tree/master/BasicSample) Sample From google. [This Tutorial](https://kotlinfarsi.com/tutorials/android-jetpack/room/introduction) is provided by this Sample.
